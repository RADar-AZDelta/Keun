...
export default class FirebaseImpl implements IUpdatedFunctionalityImpl {
  ...
  async syncFile(data: any): Promise<File | void> {
    return new Promise(async (resolve, reject) => {
  ...
  async cache(data: any): Promise<void | File> { }
